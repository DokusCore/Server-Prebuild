...
<p align="center">
 ...
 <b>DokusCore Instruments (v1.0.1)</b> - Play an instrument or a Midi file!.
</p>
...
---
# Installation
Simply extract the `DokusCore--Instruments` into your `resources` folder, and <br>
start it via `ensure DokusCore--Instruments`.
