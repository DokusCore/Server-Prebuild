...
_Spawner = {
  ...
  StartItems = {
    ...
    { Item = 'scratchcards',  Amount = 3,  Type = 'Consumable' }
  },
  ...
  Cutscenes    = {
    ...
    { ID = 3, City = 'Rhodes',      Coords = { Heading = 175.0, Start = vec3(0.0, 0.0, 0.0), End = vec3(0.0, 0.0, 0.0) } },
    { ID = 4, City = 'Rhodes',      Coords = { Heading = 175.0, Start = vec3(1.0, 1.0, 1.0), End = vec3(0.0, 0.0, 0.0) } },
  },
