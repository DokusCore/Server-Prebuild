...
function GetPointRot()
  ...
  if cr >= 0 and cr < 135 then return 1
  elseif cr >= 135 then return 2
  elseif cr <= -136 then return 5
  elseif cr <= -46 then return 4
  elseif cr <= 0 then return 3
  end
end
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
...
RegisterCommand('point', function()
  if (not (isPointing)) then triggerPointing() end
  if (isPointing) then
    isPointing = false
    Wait(150)
    currAnim = nil
    StopAnimTask(PedID(), dict, currAnim, 1.0)
    ClearPedTasks(PedID())
  end
end)
--------------------------------------------------------------------------------
