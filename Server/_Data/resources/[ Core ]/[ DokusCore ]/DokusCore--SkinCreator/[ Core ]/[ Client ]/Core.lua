...
AddEventHandler('DokusCore:SkinCreator:OpenMenu', function(PedID, pCoords)
  if (_Modules.SkinCreator) then
    ...
    Notify('Switch gender first to prevent your character getting spaghetti arms!', 'TopLeft', 30000)
    Notify('You can always reopen the skin menu via the character menu with TAB', 'TopLeft', 30000)
