...
CreateThread(function()
  ...
  Tabi(BPos, { ID = MSG("MexicoBridge2").MSG, Hash = 784218150,   Coords = vector3(-3914.6, -3940.6, -16.5) })
  Tabi(BPos, { ID = MSG("MexicoBridge3").MSG, Hash = 784218150,   Coords = vector3(-1489.0, -2755.6, 64.2) })
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
local ReservedZones = false
RegisterNetEvent('DokusCore:WorldEdits:Mexico:Bridge:Teleport:1:Enter', function()
  if (not (ReservedZones)) then
    local PedID = GetPedOrMount()
    local Coords = vec3(-1461.9, -2791.7, 63.5)
    SetCoords(PedID, Coords)
    SetEntityHeading(PedID, 220.0)
  end
end)
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
RegisterNetEvent('DokusCore:WorldEdits:Mexico:Bridge:Teleport:1:Exit', function()
  ReservedZones = false
end)
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
RegisterNetEvent('DokusCore:WorldEdits:Mexico:Bridge:Teleport:2:Exit', function()
  if (ReservedZones) then Wait(3000) ReservedZones = false end
end)
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
RegisterNetEvent('DokusCore:WorldEdits:Mexico:Bridge:Teleport:2:Enter', function()
  ReservedZones = true
end)
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
